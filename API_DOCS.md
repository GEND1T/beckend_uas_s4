...
- **Success Response:**
  ...
  - **Fields in Response:**
    ...
    - `calculationDetails` (Object): The optimized single-row aggregate metrics for visual calculations:
      - `saw` (Object): True min/max values of C1-C8 criteria columns across all eligible products.
      - `wp` (Object): True sum of `skor_s` (Total S) across all eligible products.
      - `topsis` (Object): True square root divisor values (bagi_c1 to bagi_c8) across all eligible products.
  - **Example:**
  ```json
  {
    "success": true,
